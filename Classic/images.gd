...
#		- If a -120 is encountered, a very special case happens: It expects the number after it to be the number of rows to paint with the LAST color in the palette (typically transparent). 
#		This is to quickly compress transparent rows that may be used for rotations or logos.
